...
from module_img.service.news_img_service import News_imgService
...
async def add_news_news_img(
    ...
    add_news_img.update_by = current_user.user.user_name
    add_news_img.update_time = datetime.now()
    add_news_img.create_by = current_user.user.user_name
    add_news_img.create_time = datetime.now()
