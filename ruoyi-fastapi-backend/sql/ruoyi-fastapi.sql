...
create table sys_dept (
  ...
  primary key (dept_id)
) engine=innodb auto_increment=200 comment = '部门表' charset=utf8mb4;;
...
create table sys_user (
  ...
  primary key (user_id)
) engine=innodb auto_increment=100 comment = '用户信息表' charset=utf8mb4;
...
(
  ...
  remark        varchar(500)    default null               comment '备注',
  primary key (post_id)
) engine=innodb comment = '岗位信息表' charset=utf8mb4;
...
create table sys_role (
  ...
  remark               varchar(500)    default null               comment '备注',
  primary key (role_id)
) engine=innodb auto_increment=100 comment = '角色信息表' charset=utf8mb4;
...
create table sys_menu (
  ...
  primary key (menu_id)
) engine=innodb auto_increment=2000 comment = '菜单权限表' charset=utf8mb4;
...
) engine=innodb comment = '用户和角色关联表' charset=utf8mb4;
...
) engine=innodb comment = '角色和菜单关联表' charset=utf8mb4;
...
) engine=innodb comment = '角色和部门关联表' charset=utf8mb4;
...
) engine=innodb comment = '用户与岗位关联表' charset=utf8mb4;
...
) engine=innodb auto_increment=100 comment = '操作日志记录' charset=utf8mb4;
...
(
  ...
  primary key (dict_id),
  unique (dict_type)
) engine=innodb auto_increment=100 comment = '字典类型表' charset=utf8mb4;
...
) engine=innodb auto_increment=100 comment = '字典数据表' charset=utf8mb4;
...
) engine=innodb auto_increment=100 comment = '参数配置表' charset=utf8mb4;
...
) engine=innodb auto_increment=100 comment = '系统访问记录' charset=utf8mb4;
...
) engine=innodb auto_increment=100 comment = '定时任务调度表' charset=utf8mb4;
...
) engine=innodb comment = '定时任务调度日志表' charset=utf8mb4;
...
) engine=innodb auto_increment=10 comment = '通知公告表' charset=utf8mb4;
...
) engine=innodb auto_increment=1 comment = '代码生成业务表' charset=utf8mb4;
...
) engine=innodb auto_increment=1 comment = '代码生成业务表字段' charset=utf8mb4;